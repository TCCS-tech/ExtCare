class Admin::StudentsController < Admin::BaseController
  ...
  def update
    @student = Student.find(params[:id])
    attributes = params.expect(student: [ :first_name, :last_name, :grade, :blackbaud_id, :student_id, :guardian_list, :additional_adult_list, :notes, :hidden, :staff, :prepaid_am, :prepaid_pm ])
  ...
  private
    def student_params
      params.expect(student: [ :first_name, :last_name, :grade, :blackbaud_id, :student_id, :guardian_list, :additional_adult_list, :notes, :staff, :prepaid_am, :prepaid_pm ])
    end
